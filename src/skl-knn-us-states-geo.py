...
# This script is intended to be submitted as a script outside of a Pipeline.
...
def main():
    ...
    # experiment_name: skl-knn-us-states-geo <class 'str'>

    if boolean_flag_arg('--display-secrets'):
    ...
    df = Dataset.get_by_name(ws, name='postal_codes_us.csv').to_pandas_dataframe()
    #df = Dataset.get_by_name(ws, name='postal_codes_us.csv', version=2).to_pandas_dataframe()
