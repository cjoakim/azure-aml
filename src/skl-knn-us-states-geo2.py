...
# This script is intended to be submitted as a script inside a Pipeline with PipelineData (wip).
...
def main():
    ...
    input = keyword_arg('--input', None)
    print('input: {} '.format(input))

    os.system('cat {}'.format(input))
    ...
    df = pd.read_csv(input, delimiter=',', header=0)
